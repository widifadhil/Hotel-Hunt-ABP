                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="{{ url('admin/login') }}">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" @if(Cookie::has('adminuser')) value="{{Cookie::get('adminuser')}}" @endif id="username"
                                                name="username" aria-describedby="emailHelp" placeholder="Username">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"@if(Cookie::has('adminpwd')) value="{{Cookie::get('adminpwd')}}" @endif id="password"
