...
<head>
    ...
    <link rel="icon" href="/img/HH-Title-01.png">
    <title>Admin Hotel Hunt</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background: linear-gradient(45deg, rgba(0,174,239,1) 0%, rgba(13,44,74,1) 100%);"
            ...
            <li class="nav-item">
                <a class="nav-link @if (!request()->is('admin/hotel*')) collapsed @endif" href="#" data-toggle="collapse"
                    data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-hotel"></i>
                    <span>Hotel</span>
                </a>
                <div id="collapseTwo" class="collapse @if (request()->is('admin/hotel*')) show @endif "
                    aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('admin/hotel/create') }}">Add New</a>
                        <a class="collapse-item" href="{{ url('admin/hotel') }}">View All</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="roomtypeMaster" class="collapse @if (request()->is('admin/roomtype*')) show @endif"
                    aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <!-- Room Master -->
            <li class="nav-item">
                <a class="nav-link @if (!request()->is('admin/room*')) collapsed @endif collapsed" href="#"
            ...
            <!-- Customer Master -->
            <li class="nav-item">
                <a class="nav-link @if (!request()->is('admin/customer*')) collapsed @endif collapsed" href="#"
