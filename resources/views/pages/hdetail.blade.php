        ...
        <div class="col-lg-9 pd-5 mt-5 mt-lg-0" id="hotel-view">
          ...
          <div class="container" style="background: white; border-radius:10px;">
            <div class="col p-3">
              ...
              <div class="d-flex justify-content-center pb-3"><hr width="900px" style="height:2px"></div>
              {{-- Carousel --}}
            ...
            <div class="row justify-content-end">
              ...
              <div class="col-4 pt-3" style="text-align: right;">
                ...
                <button class="btn btn-primary" type="button" style="width: 223px;height: 41px;background: #0A9CDF;border-radius: 10px;border:0px">Select Room</button>
              </div>
            </div>
