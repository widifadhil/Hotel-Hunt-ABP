            ...
            <div class="d-flex justify-content-center">
                ...
                <div class="col-md-6 pd-5 mt-5 mt-md-0" id="hotel-view">
                    ...
                    <div class="container" style="padding-top:15px;">
                        ...
                        <div class="col"
                            style="padding:10px; background: white; border-radius:10px ;filter: drop-shadow(0px 0px 6px rgba(154, 154, 154, 0.44));border: 1px solid #AFAFAF;">
                            ...
                            <div class="row" style="padding-top:5px;">
                                <div class="col" style="background: #E8E8E8;margin-left:2px;margin-right:2px">
                                    <h6 style="padding-top: 5px">Hotel Utap Bandung</h6>
                                </div>
                            </div>
                            <div class="row" style="padding-top:10px;margin-bottom:-5px">
                                <div class="col" style="color: white">
                                    <h6
                                        style="background:#00AEEF;padding-left:10px;padding-top:5px;font-weight: 500;font-size: 14px;height: 28px;border-radius:35px;width: 63px;">
                                        Lunas</h6>
                                </div>
                            </div>
                        </div>
