        ...
        <div class="col-lg-6 pd-5 mt-5 mt-lg-0" id="hotel-view">
          ...
          <div class="container" style="padding-top:15px">
            <div class="col" style="padding:10px; background: white; border-radius:10px">
              ...
              {{-- hr --}}
              <div class="d-flex justify-content-between" style="margin-top: -15px"><hr width="900px" style="height:2px"></div>
              {{-- end hr --}}
              <form action="">
              ...
              <div class="d-grid gap-2">
              <button class="btn btn-primary" type="button" style="background-color: #00AEEF;border:0px">Submit</button>
            </div>
              </div>
            </div>
          </div>
